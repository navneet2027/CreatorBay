...
import { toast } from "sonner";
import axios from "axios";
import { LogIn, Loader2, Crown, Users } from "lucide-react";
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="bg-neutral-900 rounded-2xl border border-gray-800 overflow-hidden">
          ...
          <div className="p-6 border-b border-gray-800">
            ...
            <h2 className="text-2xl font-bold text-white mb-1">Welcome Back, Creator</h2>
            <p className="text-gray-400 text-sm">Login to manage your content and subscribers</p>
          </div>
